  ...
  return (
    <div className="p-6">
      <div className="max-w-6xl mx-auto">
        <h2 className="text-2xl font-mono text-white mb-6">{workspace.name} Boards</h2>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {workspace.boards.filter(b => !b.isDeleted).map((board) => {
            let totalTasks = 0;
            let pendingTasks = 0;
            ...
            return (
              ...
              >
                ...
                <div className="mt-auto grid grid-cols-2 gap-4">
                  ...
                  <div className="flex flex-col">
                    <span className="text-xs text-syntax-grey uppercase tracking-wider font-mono">Completed Tasks</span>
                    <span className="text-lg text-white font-mono">{completedTasks}</span>
                  </div>
                </div>
              </div>
            );
          ...
          {isAdmin && (
            ...
            >
              ...
              <span className="text-syntax-grey font-mono group-hover:text-white transition-colors">Add Board</span>
            </div>
          )}
        </div>
      </div>
