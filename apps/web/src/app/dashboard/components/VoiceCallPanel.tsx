...
export function VoiceCallPanel({ boardId }: { boardId: string }) {
  ...
  return (
    <div className="absolute right-0 top-16 h-[calc(100%-4rem)] w-80 border-l border-white/10 bg-obsidian-night/95 backdrop-blur-md p-6 flex flex-col transition-all overflow-y-auto z-[70] shadow-[-4px_0_25px_rgba(0,0,0,0.5)]">
