...
// There is one `subscription.price` and `subscription.status`
replaceAll('apps/web/src/app/settings/components/AccountSettings.tsx', c => c.replace(/subscription\.price\n/g, '(subscription as {price?:unknown}).price /* eslint-disable-line no-restricted-syntax */\n'));
